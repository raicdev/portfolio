    ...
    <div className="space-y-10">
      ...
      <div className="space-y-8 text-sm text-muted-foreground leading-relaxed">
        <section className="space-y-3">
          ...
          <p>
            By installing and using browser extensions developed by rai (hereinafter referred to as
            &quot;the Service&quot;), you agree to be bound by these Terms of Service. If you do not
            agree with any part of these terms, please uninstall the extension.
          </p>
        </section>

        <section className="space-y-3">
          <h2 className="text-base font-medium text-foreground">Use of Service</h2>
          <p>
            The Service is provided for personal and commercial use. You agree to use the Service in
            compliance with all applicable laws and regulations.
          </p>
          <p>
            You agree not to misuse the Service, including but not limited to attempting to reverse
            engineer, modify, or distribute the Service without authorization.
          </p>
        </section>

        <section className="space-y-3">
          <h2 className="text-base font-medium text-foreground">User Content</h2>
          <p>
            You retain ownership of any content you create or interact with through the Service. By
            using the Service, you grant us a limited license to process your content as necessary
            to operate the Service.
          </p>
          <p>
            You are solely responsible for the content you engage with and must ensure your usage
        ...
        <section className="space-y-3">
          ...
          <p>
            The Service, including its code, design, and functionality, is owned by the developer
        ...
        <section className="space-y-3">
          ...
          <p>
            ...
            without cause. You may stop using the Service at any time by uninstalling it.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            ...
            posted on this page with an updated date. Your continued use of the Service after
